...
class image_feature:
    ...
    def __init__(self):
        ...
        if VERBOSE :
          print("subscribed to /bebop/image_raw/compressed")
    ...
    def callback(self, ros_data):
        ...
        # method = "GridFAST"
        # feat_det = cv2.FeatureDetector_create("FAST")
        # time1 = time.time()
        ...
        # if VERBOSE :
        #   print('%s detector found: %s points in: %s sec.'%("FAST", len(featPoints),time2-time1))
